    ...
    var _componentUiAutocomplete = function() {
        ...
        $.getJSON('https://think.cs.vt.edu/corgis/datasets/json/airlines/airlines.json', function(data) {
            for (var i = 0; i < data.length; i++) {
                var city = data[i].Airport.Name
                var city_name = city.split(':')[0];
            ...
            // Add demo data
            var availableTags = Object.keys(cities);;
        ...
        var projects = [{
                ...
                desc: 'Compare statistics between 2 cities during a particular year'
            },
            {
                label: 'Monthly Comparison',
                desc: "Analyze a particular statistics\' changing trend over a couple of years"
            },
            {
                label: 'It\'s Brain',
        ...
        $('#ac-remote').autocomplete({
            minLength: 2,
            source: '../static/global_assets/demo_data/jquery_ui/autocomplete.php',
            search: function() {
